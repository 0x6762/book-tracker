...
// Load keystore properties if present (for release signing). Falls back to debug signing if absent.
...
android {
    namespace = "com.readr.booktracker"
    ...
    defaultConfig {
        // Unique Application ID for Play
        applicationId = "com.readr.booktracker"
